...
Official Python client for the DocVerify document verification API.

[![PyPI](https://img.shields.io/pypi/v/docverify)](https://pypi.org/project/docverify/)
[![Python](https://img.shields.io/pypi/pyversions/docverify)](https://pypi.org/project/docverify/)
...
**Requirements:** Python >= 3.10, httpx >= 0.25.0
...
Verify multiple AI outputs against one source:
...
[github.com/docverifyai/python-sdk](https://github.com/docverifyai/python-sdk)
